...
nycprop2=read.csv('E:\\3rd year 2nd semester\\ST3082-statistical learning\\2nd project\\advance\\nycprop_processed.csv')
dim(nycprop2)
names(nycprop2)
...
saveRDS(nycprop2_rf2, "model_rf2.rds")
...
new_data <- data.frame(
  ...
  BOROUGH_X4 = 0,
  BOROUGH_X5 = 0,
  TAX.CLASS.AT.TIME.OF.SALE_X1 = 1,
  TAX.CLASS.AT.TIME.OF.SALE_X2 = 0,
  TAX.CLASS.AT.TIME.OF.SALE_X4 = 0,
  Neighborhood_Category_central_brooklyn = 1,
  Neighborhood_Category_central_queens = 0,
  Neighborhood_Category_eastern_brooklyn = 0,
  Neighborhood_Category_Lower.Manhattan = 0,
  Neighborhood_Category_mid_islands_staten = 0,
  Neighborhood_Category_Midtown.Manhattan = 0,
  Neighborhood_Category_north_shore_staten = 0,
  Neighborhood_Category_northeast_bronx = 0,
  Neighborhood_Category_northeastern_queens = 0,
  Neighborhood_Category_northern_brooklyn= 0,
  Neighborhood_Category_northwest_bronx=0,
  Neighborhood_Category_northwest_brooklyn = 0,
  Neighborhood_Category_northwestern_queens = 0,
  Neighborhood_Category_south_shore_staten = 0,
  Neighborhood_Category_southeast_bronx = 0,
  Neighborhood_Category_southeastern_queens = 0,
  Neighborhood_Category_southern_brooklyn = 0,
  Neighborhood_Category_southwest_bronx=0,
  Neighborhood_Category_southwest_brooklyn =0,
  Neighborhood_Category_southwestern_queens=0,
  Neighborhood_Category_the_rockaways=0,
  Neighborhood_Category_Upper.Manhattan=0,
  Neighborhood_Category_West.Side=0,
  Building_class_cat2_class_A = 1,
  Building_class_cat2_class_B = 1,
  Building_class_cat2_class_C= 0,
  Building_class_cat2_class_D= 0,
  Building_class_cat2_class_other=0,
  Building_class_cat2_class_R= 0,
  Building_class_cat2_class_S= 0)


pred_rf2 <- predict(nycprop2_rf2, data = new_data )$predictions
